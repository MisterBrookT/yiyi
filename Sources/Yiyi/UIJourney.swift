...
@MainActor func runUIJourney(outdir: URL) throws {
    ...
    try page("General")
    try check("triggers.two-cards", controller.control(accessibilityID: "section.keyboard") != nil && controller.control(accessibilityID: "section.mouse-/-trackpad") != nil && controller.control(accessibilityID: "superkey.popup") != nil && controller.control(accessibilityID: "pointer.enabled") != nil)
