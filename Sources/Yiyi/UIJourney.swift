...
@MainActor func runUIJourney(outdir: URL) throws {
    ...
    try check("hyper.not-in-commands", controller.control(accessibilityID: "superkey.popup") == nil)
    ...
    try page("General")
    try check("triggers.section", controller.control(accessibilityID: "section.triggers") != nil && controller.control(accessibilityID: "superkey.popup") != nil && controller.control(accessibilityID: "pointer.enabled") != nil)
